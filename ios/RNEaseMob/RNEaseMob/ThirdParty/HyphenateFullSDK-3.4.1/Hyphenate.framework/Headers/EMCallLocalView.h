...
- (CGPoint) layerPointFromRatioPoint:(CGPoint)pointOfRatio fromRemote:(BOOL)fromRemote;
- (CGPoint) viewPointFromLayerPoint:(CGPoint)pointOfLayer;
- (CGPoint) devicePointFromLayerPoint:(CGPoint)pointOfLayer;
